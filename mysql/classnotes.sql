...
-- 数据表的操作
    ...
    insert into classes values(0, "python01大神");
    select * from classes;
...
-- 增删改查（curd）
    ...
    -- 增加
        ...
        insert into students values(default, "西施", 20, 2, 1, "1990-01-01"),
                                    (default, "王昭君", 20, 2, 1, "1990-01-01");
    ...
    update students set age=18 where name="西施";
    update students set cls_id=4 where name="郭靖";
